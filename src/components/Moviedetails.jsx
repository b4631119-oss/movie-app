...
import MoviedetailsSkeleton from "./templates/MovieDtailShimmer";

const Moviedetails = () => {
  const { pathname } = useLocation();
  console.log(pathname)
  // /movie/details/552524/trailer
  ...
  return info ? (
    <div
      style={{
        background: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.9)) ,url(https://image.tmdb.org/t/p/w1280/${info.detail.backdrop_path})`,
                  ...
                  info.watchproviders.flatrate.map((c, i) => {
                    return (
                      <img
                        ...
                        alt={c.provider_name} // <-- ADD DESCRIPTIVE ALT
                      />
                    );
                  })}
              </div>
